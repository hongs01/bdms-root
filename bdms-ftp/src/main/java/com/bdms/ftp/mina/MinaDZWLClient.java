...
public class MinaDZWLClient {
	...
	public static void main(String[] args) throws FileSystemException {
		...
		FileObject fileObject = fsManager.resolveFile("ftp://Administrator:DSwh110119@192.168.7.194/DZWL/");
		...
		DefaultFileMonitor monitor = new DefaultFileMonitor(new FileListener() {
			...
			public void fileCreated(FileChangeEvent changeEvent)
				...
				//VFSUtils.dzwlFileToSocket(changeEvent);	
			}
