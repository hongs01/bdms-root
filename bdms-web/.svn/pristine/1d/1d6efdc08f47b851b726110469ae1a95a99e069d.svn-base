...
<%-- <script type="text/javascript" src="${APP_PATH}js/highcharts/themes/dark-blue.js"></script> --%>
...
<script type="text/javascript">
	...
	$(function() {
		...
		//alert(getGFtimesAM("17:35:00"));
		//alert(getGFtimesPM("17:35:00"));
		...
		$.getJSON("${APP_PATH}dams/metro/in/lines", { "resultType": "json" }, function(data, textStatus)
			...
			$( "#changetheme" ).on("click",function(event,ui){
				$.getJSON("${APP_PATH}dams/metro/in/chtheme", { "resultType": "json" }, function(data, textStatus)
						{
						   //alert(data);
						   location.reload();
						}); 
...
<div class="ui-layout-center west-body-background">
	<div style="width:100%; height:100px;">
		<div id="lineStatInfo"><span class="font-family-color">全市 进站人数</span></div>
	</div>
	...
	<div id="right" style="float:left;width:380px;padding-top:10px">
		...
		<div style="padding: 5px;width: 100%;">
			...
			<div style="padding: 5px;width:65px;float:left">
				<a id="changetheme" style="font-family: '微软雅黑';width: 60px;" >切换主题</a>
			</div>
			</div>
		</div>
		...
		<div style="width: 380px ;margin-top: 30px;font-family: '微软雅黑';">
			...
			<div style="width:100%;BORDER-TOP: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
				...
				<div style="width:200px; float:left;font-weight:bold;padding-left:10px;font-size:18px" class="just-font">进站人数</div>
			</div>
			...
			<div style="width:100%;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>   		
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div style="width:300px; float:left;font-weight:bold;padding-left:10px;font-size:18px" class="just-font">晚高峰进站总人数（17:00-19:00）</div>
			</div>
			<div class="renPlusNum" >
...
function changeStationImgData(sid){
    ...
    jQuery.post(yc,{dateTime:dtime,sid:station},function(data){
     ...
     hAfter = data.pAfter;
	  ...
	  //alert(hcharts.series[0].color="red");
		...
		hcharts = new Highcharts.Chart({ 
         ...
         formatter: function () {  
	        ...
	        series:[
	        	...
	        	{name:"进站",data:out,color:'rgb(0,84,248)'}
	        ]
	    });
	}
