...
<%-- <script type="text/javascript" src="${APP_PATH}js/highcharts/themes/grid.js"></script> --%>
			...
			$("#selectmenu").on("selectmenuchange",function( event, ui){
				...
				if(linenum!="-"){
					...
					if(linenum == "00"){
						...
						$("#lineStatInfo").html("<span "+style+">换乘线 进出站人数  </span>");
						...
						$("#lineStatInfo").html("<span style='height:50px;color;"+lineNoCo[parseInt(str)]+"'>"+str+"</span><span "+style+"> 号线 进出站人数 </span>");
						$('#lineStatInfo').css("display","none");
						$('#lineStatInfo').fadeIn(200);
					...
					//clearallinfo();
					//changeTitleBg("top");
					$("#lineStatInfo").html("<span "+style+">全市 进出站人数</span>");
					$('#lineStatInfo').css("display","none");
					$('#lineStatInfo').fadeIn(200);
				...
				$.getJSON("${APP_PATH}dams/metro/in/station/"+stat, { "resultType": "json" }, function(data, textStatus)
					{
						if(stat!="-"){
							if(linenum!="00"){
								$("#lineStatInfo").html("<span style='color:"+lineNoCo[parseInt(str)]+"'>"+str+"</span><span "+style+"> 号线 </span><span style='color:"+lineNoCo[parseInt(str)]+"'>"+data.name+"</span><span "+style+"> 进出站人数</span>");
							}else{
								$("#lineStatInfo").html("</span><span "+style+">换乘线  </span><span style='color:"+lineNoCo[parseInt(str)]+"'>"+data.name+"</span><span "+style+"> 进出站人数</span>");
							}
							//changeStationLogo(data);
							changeStationImgData(stat);
						}else{
							if(linenum!="00"){
								$("#lineStatInfo").html("<span style='color:"+lineNoCo[parseInt(str)]+"'>"+str+"</span><span "+style+"> 号线 </span><span "+style+"> 进出站人数</span>");
							}else{
								$("#lineStatInfo").html("</span><span "+style+">换乘线  </span><span "+style+"> 进出站人数</span>");
							}
							changeStationImgData(linenum+"00");
						}
					});
...
function refreshPNums1(num1,num2,num3,num4,num12,num22,num32,num42,pSize){
	refreshPNum("#ren1",num1,num12,1);
	refreshPNum("#totalren1",num2,num22,pSize);
	refreshPNum("#totalrenAM1",num3,num32,getGFtimesAM($("#updatetime").text()));
	refreshPNum("#totalrenPM1",num4,num42,getGFtimesPM($("#updatetime").text()));
}
...
<div class="ui-layout-center west-body-background">
	<div style="width:100%; height:100px;">
		<div id="lineStatInfo"><span class="font-family-color">全市 进出站人数</span></div>
	</div>
	...
	<div class="update-div">数据更新时间：<span id="updatetime">14:00:00</span></div>
	</div>				 
</div>
 
<div class="ui-layout-east east-div"> 
	<!-- start right -->
	<div id="right" style="float:left;width:370px;padding-top:10px">
	
		<div style="padding: 5px;width: 360px">
		...
		<div style="width: 370px ;margin-top: 30px;font-family: '微软雅黑';">
			<!-- 进站人数 -->
			<div style="width: 360px; padding-top: 25px;float:left" >
			<div style="width:360px;BORDER-TOP: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:200px; float:left;font-weight:bold;padding-left:10px;font-size:18px">进站人数</div>
			</div>
			<div class="renPlusNum" >
				<div style="float:left;width:350px;padding-top:10px" id="renwait">
			...
			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
			...
			<!-- <div style="width: 100%; padding-top: 20px;float:left">
      		...
      		<!--进站总人数 -->
      		<div style="width: 360px; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:200px; float:left;font-weight:bold;padding-left:10px;font-size:18px">进站总人数</div>
			</div>
			<div class="renPlusNum" >
				<div style="float:left;width:350px;padding-top:10px" id="totalrenwait">
			...
			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:300px; float:left;font-weight:bold;padding-left:10px;font-size:18px">早高峰进站总人数（07:00-09:00）</div>
			</div>
			<div class="renPlusNum" >
			...
			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>   		
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:300px; float:left;font-weight:bold;padding-left:10px;font-size:18px">晚高峰进站总人数（17:00-19:00）</div>
			</div>
			<div class="renPlusNum" >
...
<!-- 			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
 -->      		
			...
			<div style="width:360px;BORDER-TOP: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:200px; float:left;font-weight:bold;padding-left:10px;font-size:18px">出站人数</div>
			</div>
			<div class="renPlusNum" >
				<div style="float:left;width:100%;padding-top:10px" id="renwait">
      				<div class="ren" id="ren1" style="float:left;margin-left:5px"></div>
      				<div  style="width:100%;height: 22px;font-size:14px">
      					<span id="ren1num"></span>
      					<span id="ren1numh"></span>
      				</div>
      			</div>
			</div>
			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
			...
			<!-- <div style="width: 100%; padding-top: 20px;float:left">
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:200px; float:left;font-weight:bold;padding-left:10px;font-size:18px">出站总人数</div>
			</div>
			<div class="renPlusNum" >
				<div style="float:left;width:100%;padding-top:10px" id="totalrenwait">
      				<div class="yeren" id="totalren1" style="float:left;margin-left:5px"></div>
      				<div  style="width:100%;height: 22px;font-size:14px">
      					<span id="totalren1num"></span>
      					<span id="totalren1numh"></span>
      				</div>
      			</div>
			</div>
			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:300px; float:left;font-weight:bold;padding-left:10px;font-size:18px">早高峰出站总人数（07:00-09:00）</div>
			</div>
			<div class="renPlusNum" >
				<div style="float:left;width:100%;padding-top:10px" id="totalrenAMwait">
      				<div class="orren" id="totalrenAM1" style="float:left;margin-left:5px"></div>
      				<div  style="width:100%;height: 22px;font-size:14px">
      					<span id="totalrenAM1num"></span>
      					<span id="totalrenAM1numh"></span>
      				</div>
      			</div>
			</div>  
			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>   		
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:300px; float:left;font-weight:bold;padding-left:10px;font-size:18px">晚高峰出站总人数（17:00-19:00）</div>
			</div>
			<div class="renPlusNum" >
				<div style="float:left;width:100%;padding-top:10px" id="totalrenPMwait">
      				<div class="reren" id="totalrenPM1" style="float:left;margin-left:5px"></div>
      				<div style="width:100%;height: 22px;font-size:14px">
      					<span id="totalrenPM1num"></span>
      					<span id="totalrenPM1numh"></span>
      				</div>
      			</div>
			</div> 
			<div style="width:360px;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
...
var url = "${APP_PATH}dams/metro/in/dayenterdata";
var yc  = "${APP_PATH}dams/metro/in/dayenterpredictedata";

var url1 = "${APP_PATH}dams/metro/out/dayexitdata";
var yc1 = "${APP_PATH}dams/metro/out/dayexitpredictedata";
var station = "0099";
	  ...
	  jQuery.post(url,{dateTime:dtime,sid:station},function(data){
			 ...
			 //console.log(data);
			  refreshPNums(data.pNow,data.pCount,data.pBefore,data.pAfter,data.hNow,data.hCount,hBefore,hAfter,data.pointSize);
			       ...
			       jQuery.post(yc1,{dateTime:dtime,sid:station},function(data){
		        ...
		        yAxisBands = eval(data.yAxis);
		       // console.log(yAxisBands);
		    	 // showimg1([],[]);
		  	  hcharts.series[2].setData(data.data);
		  	  
		  	  jQuery.post(url1,{dateTime:dtime,sid:station},function(data){
		  			 hcharts.series[3].setData(data.data);
		  			 updateLabel.text(data.pDate);
		  			 refreshPNums1(data.pNow,data.pCount,data.pBefore,data.pAfter,data.hNow,data.hCount,hBefore,hAfter,data.pointSize);
		  		 });
...
//使用  highcharts 画图
function showimg(ind,out,ind1,out1){
	...
	if("${THEME}"=="black/dot-luv"){
		hcharts = new Highcharts.Chart({ 
         ...
         formatter: function () {  
	        ...
	        series:[
	        	{name:"进站历史",data:ind, visible:false},
	        	{name:"进站实时",data:out},
	        	{name:"出站实时",data:ind},
	        	{name:"出站历史",data:out, visible:false}
	        ]
	    });
	}else{
		hcharts = new Highcharts.Chart({ 
         ...
         formatter: function () {  
	        ...
	        plotOptions: {
		      ...
		      series:[
	        	{name:"进站历史",data:ind,color:'rgb(227,178,176)', visible:false},
	        	{name:"进站实时",data:out,color:'rgb(255,34,23)'},
	        	{name:"出站历史",data:out,color:'rgb(135,179,203)', visible:false},
	        	{name:"出站实时",data:ind,color:'rgb(0,84,248)'}
	        ]
	    });
	}
