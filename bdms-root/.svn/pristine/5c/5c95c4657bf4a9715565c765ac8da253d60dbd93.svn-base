						...
						$.getJSON("${APP_PATH}dams/metro/in/stationsbyline/"+lineIdParam, { "resultType": "json" }, function(data, textStatus)
								{
								   $("#selectmenu2").empty();//先清空tbody  
									...
									$("#selectmenu2").selectmenu("refresh");
									$("#lineStatInfo").html("<span style='color:"+lineNoCo[parseInt(lineIdParam)]+"'>"+lineIdParam+"</span><span "+style+"> 号线 </span><span style='color:"+lineNoCo[parseInt(lineIdParam)]+"'>"+sName+"</span><span "+style+"> 进出站人数差</span>");
								});
					}
			...
			$("#selectmenu").on("selectmenuchange",function( event, ui){
				...
				if(linenum!="-"){
					...
					if(linenum == "00"){
						...
						$("#lineStatInfo").html("<span "+style+">换乘线 进出站人数差  </span>");
						...
						$("#lineStatInfo").html("<span style='height:50px;color;"+lineNoCo[parseInt(str)]+"'>"+str+"</span><span "+style+"> 号线 进出站人数差 </span>");
						$('#lineStatInfo').css("display","none");
						$('#lineStatInfo').fadeIn(200);
					...
					//clearallinfo();
					//changeTitleBg("top");
					$("#lineStatInfo").html("<span "+style+">全市 进出站人数差</span>");
					$('#lineStatInfo').css("display","none");
					$('#lineStatInfo').fadeIn(200);
				...
				$.getJSON("${APP_PATH}dams/metro/in/station/"+stat, { "resultType": "json" }, function(data, textStatus)
					{
						if(stat!="-"){
							if(linenum!="00"){
								$("#lineStatInfo").html("<span style='color:"+lineNoCo[parseInt(str)]+"'>"+str+"</span><span "+style+"> 号线 </span><span style='color:"+lineNoCo[parseInt(str)]+"'>"+data.name+"</span><span "+style+"> 进出站人数差</span>");
							}else{
								$("#lineStatInfo").html("</span><span "+style+">换乘线  </span><span style='color:"+lineNoCo[parseInt(str)]+"'>"+data.name+"</span><span "+style+"> 进出站人数差</span>");
							}
							//changeStationLogo(data);
							changeStationImgData(stat);
						}else{
							if(linenum!="00"){
								$("#lineStatInfo").html("<span style='color:"+lineNoCo[parseInt(str)]+"'>"+str+"</span><span "+style+"> 号线 </span><span "+style+"> 进出站人数差</span>");
							}else{
								$("#lineStatInfo").html("</span><span "+style+">换乘线  </span><span "+style+"> 进出站人数差</span>");
							}
							changeStationImgData(linenum+"00");
						}
					});
...
<div class="ui-layout-center west-body-background">
	<div style="width:100%; height:100px;">
		<div id="lineStatInfo"><span class="font-family-color">全市 进出站人数差</span></div>
	</div>
	...
	<div id="right" style="float:left;width:380px;padding-top:10px">
		...
		<div style="width: 380px ;margin-top: 30px;font-family: '微软雅黑';">
			...
			<div style="width:100%;BORDER-TOP: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
				...
				<div class="just-font" style="width:200px; float:left;font-weight:bold;padding-left:10px;font-size:18px">进出站人数差</div>
			</div>
			...
			<!-- <div style="width: 100%; padding-top: 20px;float:left">
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div id="iosum" class="just-font" style="width:200px; float:left;font-weight:bold;padding-left:10px;font-size:18px">地铁站内总人数</div>
			</div>
			<div class="renPlusNum" >
			...
			<div style="width:100%;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:330px; float:left;font-weight:bold;padding-left:10px;font-size:18px">早高峰进出站总人数差（07:00-09:00）</div>
			</div>
			<div class="renPlusNum" >
			...
			<div style="width:100%;BORDER-BOTTOM: #00686b 1px dashed; OVERFLOW: hidden; HEIGHT: 20px"></div>   		
      		...
      		<div style="width: 100%; padding-top: 20px;float:left" >
				<div style="float:left;margin-top:1px;margin-left:10px"><img src="${APP_PATH}style/jqueryUIthems/${THEME}/images/round.png"></img></div>
				<div class="just-font" style="width:330px; float:left;font-weight:bold;padding-left:10px;font-size:18px">晚高峰进出站总人数差（17:00-19:00）</div>
			</div>
			<div class="renPlusNum" >
...
var url = "${APP_PATH}dams/metro/inoutsub/dayInOutSubdata";
		...
		hcharts = new Highcharts.Chart({ 
         ...
         formatter: function () {  
	        ...
	        series:[
	        	...
	        	{name:"站内人数",data:out,color:'rgb(0,84,248)'}
	        ]
	    });
	}
