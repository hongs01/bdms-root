...
<script type="text/javascript" src="${APP_PATH}js/highcharts/highcharts.js"></script>
...
<div id="top" style="height:130px;width:100%; text-align: center;color: #FFF; font-size: 36px;">
	<div style="padding-top: 10px;">
		...
		<div style="position:relative;">
		    ...
		    <img alt="" src="${APP_PATH}style/images/title_01.png" style="width: 800px; height: 120px;">
			<div style="position:absolute;z-indent:2;left:340px;top:58px;"><span id="lineNum1" style="background:green;font-size:40px"></span></div>
			<div style="position:absolute;z-indent:2;left:377px;top:86px;"><span id="lineNum2" style="font-size:5px"></span></div>
			<div style="position:absolute;z-indent:2;left:445px;top:59px;"><span id="sname" style="font-size:20px"></span></div>
			<div style="position:absolute;z-indent:2;left:445px;top:86px;"><span id="sename" style="font-size:10px;"></span></div>
			<div style="position:absolute;z-indent:2;left:762px;top:56px;"><span id="inout" style="font-size:20px;color:red;font:bold">出站</span></div>
			<div style="position:absolute;z-indent:2;left:665px;top:82px;"><span id="ppic" style="font-size:20px;color:red;font:bold">
...
//左侧图表
 ...
 var url = "${APP_PATH}dams/elecfence/dayexitdata";
 var station = "0241";
	...
	// getData();
	 ...
	 //获取当前时间
	  ...
	  jQuery.post(url,{dateTime:dtime,sid:station},function(data){
		  ...
		  hcharts.series[0].setData(data.out) ;
